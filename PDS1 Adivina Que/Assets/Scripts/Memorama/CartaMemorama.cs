...
{
    // Referencias
    [SerializeField] private ControladorMemorama controlador;
    [SerializeField] private GameObject reversoDeCarta;         // Permite llamar desde codigo la parte de atras de la carta para activarla/desactivarla
